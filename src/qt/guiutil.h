...
/** Utility functions used by the Dorin Qt UI.
 */
namespace GUIUtil
{
...
// Render Dorin addresses in monospace font
...
// Parse "dorin:" URI into recipient object, return true on successful parsing
