                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDORPathCustom = GetArg("-zdorbackuppath", "");
    ...
    if(!strzDORPathCustom.empty()) {
        ui->wallet_customzdorbackuppath->setText(QString::fromStdString(strzDORPathCustom));
        ui->wallet_customzdorbackuppath_label->setVisible(true);
        ui->wallet_customzdorbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDORPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Dorin RPC console.") + "<br>" +
