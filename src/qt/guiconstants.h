...
/* Dorin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Dorin"
#define QAPP_ORG_DOMAIN "dorin.org"
#define QAPP_APP_NAME_DEFAULT "Dorin-Qt"
#define QAPP_APP_NAME_TESTNET "Dorin-Qt-testnet"
