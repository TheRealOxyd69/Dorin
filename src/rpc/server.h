...
extern UniValue setzdorseed(const UniValue& params, bool fHelp);
extern UniValue getzdorseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzdor(const UniValue& params, bool fHelp);
extern UniValue dzdorstate(const UniValue& params, bool fHelp);
