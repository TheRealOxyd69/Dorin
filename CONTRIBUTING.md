Contributing to Dorin Core
============================

The Dorin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dorin Core project, and is not to be
confused with overall Dorin Network Protocol consensus changes.

Whether a pull request is merged into Dorin Core rests with the project merge
...
Patches that change Dorin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dorin consensus, it must have been
...
The project leader is the release manager for each Dorin Core release.
