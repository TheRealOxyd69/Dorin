...
This mechanism has been integrated into Bitcore-Node-Dorin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Dorin-Project/insight-api-dorin#web-socket-api](https://github.com/Dorin-Project/insight-api-dorin#web-socket-api) 
* API: [https://github.com/Dorin-Project/insight-api-dorin#swifttx-transactions](https://github.com/Dorin-Project/insight-api-dorin#swifttx-transactions) 
...
By default, the Dorin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Dorin Core daemon:
