...
In order to support loading of multiple wallets in dorin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dorin.cpp.
...
Changes to dorin.cpp
----------------------
dorin.cpp is the entry point into dorin-qt, and as such, will require some minor modifications to provide hooks for
