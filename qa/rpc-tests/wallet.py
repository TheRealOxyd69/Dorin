...
#   c) node1 mines 32 blocks, so now node 0 has 60001dor, node 1 has 4250dor, node2 has none.
#   d) node0 sends 601 dor to node2, in two transactions (301 dor, then 300 dor).
