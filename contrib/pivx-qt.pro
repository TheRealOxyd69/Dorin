...
RESOURCES += src/qt/dorin.qrc src/qt/dorin_locale.qrc

TRANSLATIONS += src/qt/locale/dorin_bg.ts \
                src/qt/locale/dorin_de.ts \
                src/qt/locale/dorin_en.ts \
                src/qt/locale/dorin_es.ts \
                src/qt/locale/dorin_fi.ts \
                src/qt/locale/dorin_fr.ts \
                src/qt/locale/dorin_it.ts \
                src/qt/locale/dorin_ja.ts \
                src/qt/locale/dorin_pl.ts \
                src/qt/locale/dorin_pt.ts \
                src/qt/locale/dorin_ru.ts \
                src/qt/locale/dorin_sk.ts \
                src/qt/locale/dorin_sv.ts \
                src/qt/locale/dorin_vi.ts \
                src/qt/locale/dorin_zh_CN.ts \
                src/qt/locale/dorin_zh_TW.ts
