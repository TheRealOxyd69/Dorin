...
This means one can have an always-on dorind instance running, and another local dorind/dorin-qt instance which connects to this node and receives blocks from it.
